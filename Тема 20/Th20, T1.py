...
class Teacher(Person):
    ...
    def __init__(self, first_name: str, last_name: str, age: int, sex: str, teach_age: int, subject: str, status: str) -> None:
        super().__init__(first_name, last_name, age, sex)
        self.teach_age = teach_age
        self.subject = subject
        self.status = status
        
    def salary(self, sal: int = 1500) -> None:
    ...
    def faculty_for_teach(self) -> None:
...
class Student(Person):
    ...
    def __init__(self, first_name: str, last_name: str, age: int, sex: str, city: str, 
university: str, faculty: str, course: int, group: int, status: str) -> None:
        super().__init__(first_name, last_name, age, sex)
        self.city = city
